...
# Ranges for testing
NUM_NEIGHBORS_RANGE = [5, 10, 15, 20, 25, 30]
MIN_TOPIC_SIZE_RANGE = [10, 20, 30, 40, 50]
MIN_SAMPLE_SIZE_RANGE = [5, 6, 7, 8, 9, 10]
...
def main():
    ...
    # MAX_DOCS_FOR_TESTING = 3000  # Adjust based on your hardware
    # if len(docs) > MAX_DOCS_FOR_TESTING:
    #     print(f"\nNote: Limiting to {MAX_DOCS_FOR_TESTING} docs for test")
    #     print("Remove this limitation for final analysis.")
    #     docs = docs[:MAX_DOCS_FOR_TESTING]
