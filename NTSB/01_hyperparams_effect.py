...
VISUALIZATION_DIR = Path(
    r"C:\Users\55279\Desktop\Mestrado\0.Thesis\Codes\Approach_2\NTSB\Plots"
)
VISUALIZATION_DIR.mkdir(exist_ok=True)

# Ranges for testing
NUM_NEIGHBORS_RANGE = [5, 10, 15, 20, 25, 30, 35]
MIN_TOPIC_SIZE_RANGE = [5, 10, 15, 20, 25, 30, 35]
MIN_SAMPLE_SIZE_RANGE = [4, 5, 6, 7, 8, 9, 10]
...
def load_and_preprocess(csv_path: Path, glossary) -> List[str]:
    ...
    df["narrative"] = df["narrative"].astype(str).apply(
