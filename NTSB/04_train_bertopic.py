...
MODEL_OUT = Path(
    r"C:\Users\55279\Desktop\Mestrado\0.Thesis\Codes\Approach_2\NTSB\bertopic_model.pkl"
)
DOC_TOPICS_OUT = Path(
    r"C:\Users\55279\Desktop\Mestrado\0.Thesis\Codes\Approach_2\NTSB\doc_topics.csv"
)
TOPIC_INFO_OUT = Path(
    r"C:\Users\55279\Desktop\Mestrado\0.Thesis\Codes\Approach_2\NTSB\topic_info.csv"
)
TOPIC_KEYWORDS_OUT = Path(
    r"C:\Users\55279\Desktop\Mestrado\0.Thesis\Codes\Approach_2\NTSB\topic_keywords.json"
)
# Dedicated folder for BERTopic visualizations
VISUALIZATION_DIR = Path(
    r"C:\Users\55279\Desktop\Mestrado\0.Thesis\Codes\Approach_2\NTSB\visualizations"
)
...
def main():
    ...
    # Apply cleaning to narr_accf column
    df["narrative"] = df["narrative"].apply(
        lambda text: re.sub(pattern, '', text, flags=re.IGNORECASE).strip()
    )

    df["narrative"] = df["narrative"].apply(lambda x: expand_abbreviations(x, abbreviations))
    ...
    if probs is not None:
        ...
        binary_df.to_csv(r"C:\Users\55279\Desktop\Mestrado\0.Thesis\Codes\Approach_2\NTSB\binary_matrix.csv", index=False, encoding="utf-8")
