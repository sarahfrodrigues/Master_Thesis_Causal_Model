...
OUTPUT_DIR = r"C:\Users\55279\Desktop\Mestrado\0.Thesis\Codes\Approach_1\ASRS"
NUM_TOPICS = 14                 # Optimized number of topics
ALPHA = 0.3                     # Optimized alpha parameter
...
ALPHA_THRESHOLD = 0.2  # Alpha for binary matrix (mean + 0.5*std)
